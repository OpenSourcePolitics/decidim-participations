...
module Decidim
  module ParticipatoryProcesses
    class Permissions < Decidim::DefaultPermissions
      ...
      # HERE WE MIGHT NEED TO DEFINE MOA & CPDP ACTION AT THE PP LEVEL

      # def cpdp_action?
      #   return unless can_manage_process?(role: :cpdp)

      #   allow! if permission_action.action == :
      # end

      # def moa_action?
      #   return unless can_manage_process?(role: :moa)

      #   allow! if permission_action.action == :read || permission_action.action == :moderation
      # end
