  ...
  module Participations
    ...
    module Orderable
      ...
      included do
        ...
        # Gets how the participations should be ordered based on the choice made by the user.
        def order
        ...
        def reorder(participations)
          case order
          when "random"
            participations.order_randomly(random_seed)
          when "most_voted"
            participations.order(participation_votes_count: :desc)
          when "recent"
            participations.order(created_at: :desc)
          end
        end
      end
    end
