...
module Decidim
  module Participations
    ...
    class CreateParticipationExport < Rectify::Command
      ...
      # - :invalid if the participation wasn't valid and we couldn't proceed.
      #
      # Returns nothing.
      def call
        return broadcast(:invalid) if participatory_process.invalid?

        create_participation_export
        broadcast(:ok, export)
      end
      ...
      def create_participation_export
        ParticipationsExporterJob.perform_later(participatory_process)
      end
    end
  end
end
