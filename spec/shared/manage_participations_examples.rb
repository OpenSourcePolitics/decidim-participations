...
shared_examples "manage participations" do
  ...
  describe "creation" do
    context "when official_participations setting is enabled" do
      before do
        current_component.update_attributes!(settings: { official_participations_enabled: true })
      end
      ...
      context "when creation is enabled" do
        ...
        context "when process is related to a scope" do
          ...
          context "when geocoding is enabled" do
            before do
              current_component.update_attributes!(settings: { geocoding_enabled: true })
            end
        ...
        context "when attachments are allowed", processing_uploads_for: Decidim::AttachmentUploader do
          before do
            current_component.update_attributes!(settings: { attachments_allowed: true })
          end
    ...
    context "when official_participations setting is disabled" do
      before do
        current_component.update_attributes!(settings: { official_participations_enabled: false })
      end
  ...
  context "when the participation_answering component setting is enabled" do
    before do
      current_component.update_attributes!(settings: { participation_answering_enabled: true })
    end
  ...
  context "when the participation_answering component setting is disabled" do
    before do
      current_component.update_attributes!(settings: { participation_answering_enabled: false })
    end
